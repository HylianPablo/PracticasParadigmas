...
class Tablero:
    ...
    def MarcadasAlrededor(self,lista,i,j):
        total=0
    ...
    def Update(self,lista,i,j):
        if i>0 and j>0 and i<self.filas-1 and j<self.columnas-1:
            celda=lista[i][j-1]
            m=self.MinadoAlrededor(lista,i,j-1)
            n=self.MarcadasAlrededor(lista,i,j-1)
            button=celda.boton
            total=m-n
            self.CambiaImagenes(total,button,celda)
            ...
            celda=lista[i-1][j]
            m=self.MinadoAlrededor(lista,i-1,j)
            n=self.MarcadasAlrededor(lista,i-1,j)
            total=m-n
            button=celda.boton
            self.CambiaImagenes(total,button,celda)
            ...
            if j%2==0:
                celda=lista[i+1][j-1]
                m=self.MinadoAlrededor(lista,i+1,j-1)
                n=self.MarcadasAlrededor(lista,i+1,j-1)
                total=m-n
                button=celda.boton
                self.CambiaImagenes(total,button,celda)
