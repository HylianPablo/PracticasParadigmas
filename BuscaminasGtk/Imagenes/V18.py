...
class Tablero:
    ...
    def MuestraTablero(self,lista):
        ...
        self.window.set_border_width(20)
        self.window.set_size_request((self.filas+7)*24,(self.columnas+7)*24)
        self.window.connect("delete_event",self.delete_event)   #Cierra el programa si se pulsa la cruz del marco
        self.window.set_position(gtk.WIN_POS_CENTER)
        ...
        FFixed.put(self.button,self.filas*self.filas,(self.columnas-1)*24)
        ...
        FFixed.put(self.button,0,(self.columnas+4)*24)
    ...
    def FinMina(self,widget,event,lista,i,j,turno):
        ...
        if self.disponible==True:
            if event.button==1:
                ...
                elif mina!=1 and celda.marcada==False:
                    self.PrimeraMina=False
            ...
            #### MARCADAS ####
                ...
                if celda.cerrada==True and celda.marcada==False and self.NumeroMarcadas<self.NumeroMinas:
                    ...
                    self.Avisos.hide()
                    self.Mensaje="No se pueden marcar mas celdas que minas"
    ...
    def CrearTablero(self,widget,filas,columnas,minas):
        ...
        self.window.set_border_width(20)
        self.window.set_size_request((self.filas+7)*24,(self.columnas+7)*24)   #Encontrar un valor que ajuste la ventana, por ahora, este con 9x9 esta bien
        self.window.set_position(gtk.WIN_POS_CENTER)
        ...
        self.button.connect("clicked",self.Restart)
        self.Fixed.put(self.button,0,(self.columnas+4)*24)
        self.button.set_size_request(200,30)
        self.button.show()
        ...
        self.button.get_image().set_from_pixbuf(self.smiley[0])
        self.button.connect("clicked",self.CrearTablero,self.filas,self.columnas,self.NumeroMinas)
        self.Fixed.put(self.button,self.filas*self.filas,(self.columnas-1)*24)
        self.button.set_size_request(45,45)
        self.button.show()
